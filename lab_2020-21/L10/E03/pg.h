...
int pg_read(FILE *fp, pg_t *pgp);       //FATTO
/* non essendo struct dinamica, pulisce chiamando il distruttire di equipArray */
void pg_clean(pg_t *pgp);

void pg_print(FILE *fp, pg_t *pgp, invArray_t invArray);        //FATTO
...
void pg_updateEquip(pg_t *pgp, invArray_t invArray);            //DA MODIFICARE
